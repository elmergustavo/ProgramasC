...
int main()
{
    float cantidad_de_horas_trabajadas, precios_por_horas, cantidad_de_horas_extras, precios_de_horas_extras ;
   float cant_precio, cantextra_precioextra, sueldoliq_igss, sueldo_liquido1, descuento_igss;
